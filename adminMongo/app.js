...
var privateKey = fs.readFileSync( '/home/config/cert/privkey.pem' );
var certificate = fs.readFileSync( '/home/config/cert/fullchain.pem' );
var options = {
    key: privateKey,
    cert: certificate
  };
...
// var docu = {
//     key: fs.readFileSync('/etc/pki/nginx/private.key'),
//     cert: fs.readFileSync('/etc/pki/nginx/full_chain.pem')
//   };
...
async.forEachOf(connection_list, function (value, key, callback){
    ...
    function (err){
        ...
        server.listen(app_port, app_host, function (){
            console.log('adminMongo listening on host: https://' + app_host + ':' + app_port + app_context);
